        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Creating exceptional digital experiences with clean and efficient code.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#home" className="text-gray-300 hover:text-white hover:underline transition-colors">
                  Home
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#skills" className="text-gray-300 hover:text-white hover:underline transition-colors">
                  Skills
                </a>
              </li>
              <li>
